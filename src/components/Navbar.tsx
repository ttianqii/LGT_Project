...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-11/12 max-w-6xl">
      <div className="navbar min-h-[36px] py-0 bg-gradient-to-r from-[#000080] via-blue-900 to-blue-800 text-white shadow-2xl rounded-3xl border border-blue-900/60 backdrop-blur-xl">
        <div className="navbar-start flex items-center gap-2">
          ...
          <div className="dropdown lg:hidden ml-2">
            <div
              tabIndex={0}
              role="button"
              className="btn btn-ghost text-white hover:bg-blue-700/40 rounded-2xl transition-all duration-300 hover:scale-105"
            >
              <Menu className="h-6 w-6" />
            </div>
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content bg-gradient-to-b from-blue-600 to-blue-800 rounded-3xl z-[1] mt-3 w-60 p-3 shadow-2xl text-white border border-blue-400/30 backdrop-blur-xl"
            >
              <li>
                <a className="hover:bg-blue-700/40 rounded-2xl py-3 px-4 transition-all duration-300 hover:scale-105 font-semibold flex items-center gap-3">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-2 text-white font-semibold">
            <li>
              <a className="hover:bg-blue-700/40 rounded-2xl px-4 py-2 transition-all duration-300 hover:scale-105 flex items-center gap-2">
                <Home className="h-5 w-5" />
                {t('home')}
              </a>
            </li>
        ...
        <div className="navbar-end mr-2 flex items-center gap-3">
          ...
          <button className="btn bg-white text-[#000080] hover:bg-blue-50 hover:text-blue-800 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 font-semibold text-[15px] px-5 py-2 border-0 relative overflow-hidden group min-h-0 h-10">
